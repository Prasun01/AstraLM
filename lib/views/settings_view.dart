...
class CloudProvidersSubView extends GetView<SettingsController> {
  ...
  Widget build(BuildContext context) {
    ...
    final providers = [
      ...
      (id: 'google', name: 'Google Gemini', icon: PhosphorIconsBold.diamond),
      (id: 'deepseek', name: 'DeepSeek', icon: PhosphorIconsBold.lightning),
      (id: 'groq', name: 'Groq', icon: PhosphorIconsBold.lightning),
          ...
          children: [
            ...
            _monoGroupedCard(context, children: [
              ...
              _buildApiKeyField(
                context,
                title: 'Groq',
                controller: controller.groqKeyController,
                onChanged: (v) => controller.setApiKey('groq', v),
                isDark: isDark,
              ),
              const Divider(height: 1),
              _buildApiKeyField(
