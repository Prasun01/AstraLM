...
class ModelView extends GetView<ModelController> {
        ...
        actions: [
          Obx(() {
            ...
            return Row(
              ...
              children: [
                IconButton(
                  icon: Icon(AppIcons.onAir),
                  tooltip: 'On-Air Wi-Fi Transfer',
                  onPressed: () => _showOnAirTransferDialog(context),
                ),
                IconButton(
  ...
  void _showOnAirTransferDialog(BuildContext context) {
    final onAir = Get.find<OnAirTransferService>();
    if (!onAir.isRunning.value) {
      onAir.startServer();
    }
    showModalBottomSheet(
      ...
      builder: (ctx) => const _OnAirTransferSheet(),
    );
  }
...
class _OnAirTransferSheet extends StatelessWidget {
  const _OnAirTransferSheet();
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Obx(() {
        final running = onAir.isRunning.value;
        final url = onAir.serverUrl.value;
        final receiving = onAir.isReceivingFile.value;
        ...
        return Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: running
                                  ? const Color(0xFF3DDC84).withValues(alpha: 0.15)
                            ...
                            child: Text(
                              ...
                              style: GoogleFonts.inter(
                                fontSize: 10,
                                fontWeight: FontWeight.w700,
                                color: running ? const Color(0xFF3DDC84) : Colors.orange,
                              ),
                            ),
                          ),
                        ],
                      ...
                      const SizedBox(height: 2),
                      Text(
                        'Direct high-speed Wi-Fi model transfer',
                        style: GoogleFonts.inter(
                          fontSize: 12,
                          color: isDark ? const Color(0xFF8E95A8) : const Color(0xFF64748B),
                        ),
            ...
            if (running && url.isNotEmpty) ...[
                      ...
                      children: [
                        ...
                        FilledButton.icon(
                          onPressed: () {
                            ...
                            Get.snackbar(
                              'URL Copied',
                              'Open $url in your PC or laptop browser.',
                              snackPosition: SnackPosition.BOTTOM,
                              duration: const Duration(seconds: 3),
                            );
                          },
                          icon: const PhosphorIcon(PhosphorIconsBold.copy, size: 14),
              ...
              // Receiving Progress or Instructions
              if (receiving) ...[
                Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const SizedBox(
                            width: 14,
                            height: 14,
                            child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFF3DDC84)),
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(
                              'Receiving ${onAir.receivingFilename.value}',
                              style: GoogleFonts.inter(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                                color: isDark ? Colors.white : Colors.black87,
                          ...
                          Text(
                            DownloadService.formatSpeed(onAir.transferSpeed.value),
                            style: GoogleFonts.firaCode(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
                              color: const Color(0xFF3DDC84),
                      ...
                      ClipRRect(
                        borderRadius: BorderRadius.circular(4),
                        child: LinearProgressIndicator(
                          value: onAir.totalBytes.value > 0
                              ? (onAir.receivedBytes.value / onAir.totalBytes.value).clamp(0.0, 1.0)
                              : null,
                      ...
                      const SizedBox(height: 6),
                      Text(
                        '${DownloadService.formatBytes(onAir.receivedBytes.value)} / ${DownloadService.formatBytes(onAir.totalBytes.value)}',
                        style: GoogleFonts.inter(
                          fontSize: 11,
                          color: isDark ? const Color(0xFF8E95A8) : const Color(0xFF64748B),
                        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      _tipRow(
                        ...
                        'Phone & PC must be on the same local Wi-Fi network.',
                        isDark,
                      ),
                      const SizedBox(height: 8),
                      _tipRow(
                        PhosphorIconsBold.uploadSimple,
                        'Drag & drop .gguf, .litertlm, or .safetensors directly in browser.',
                        isDark,
                      ),
                      const SizedBox(height: 8),
                      _tipRow(
                        PhosphorIconsBold.lightning,
                        'Blazing fast local 5GHz transfer speeds (up to 100 MB/s).',
                        isDark,
                      ),
                    ],
                  ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 6),
                      Text(
                        'Tap Start Server to transfer models wirelessly.',
                        style: GoogleFonts.inter(
                          fontSize: 12,
                          color: isDark ? const Color(0xFF8E95A8) : const Color(0xFF64748B),
                        ),
              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    ...
                    child: Text(running ? 'Stop On-Air Server' : 'Start On-Air Server'),
                  ),
                ),
              ],
            ),
  ...
  Widget _tipRow(PhosphorIconData icon, String text, bool isDark) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        PhosphorIcon(
